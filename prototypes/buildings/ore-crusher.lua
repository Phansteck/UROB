...
data:extend({
  -- Burner Ore Crusher
  {
    ...
    icons = f.add_number_icon_layer({
      {
        icon = "__urob__/graphics/icons/ore-crusher.png",
        icon_size = 64,
        icon_mipmaps = 4,
      },
  ...
  },
  {
    ...
    energy_source = {
      ...
      -- Factorio 2.0: emissions_per_minute must be a dictionary[AirbornePollutantID → double]
  ...
  },
  {
    ...
    energy_source = {
      ...
      -- 2.0: dictionary form for emissions
